...
namespace BUTR.NexusUploader.Models;
...
public class FileOptions
{
    ...
    public override string ToString() =>
        $"{Name}/{Version}; UpdateVer:{UpdateMainVersion}; Previous:{(PreviousFileId.HasValue ? PreviousFileId.Value.ToString() : "unset")}; Description:{(Description.IsSet() ? "set" : "unset")}";
}